...
- Operator direction: T7 is PARKED and P7 is credited. T8 is returned to VERIFYING in
  entry `0056` for bounded witness repairs only; do not park T8, credit P8, claim
  Product STOP, or close the project without explicit operator approval.
- Git branch: `codex/t1-mechanical-host`
- Pre-bootstrap baseline: `60174bc93ef4a187a0cc7ff848a03b3d8772b804`
- Latest journal position: `0056-t8-verification-return.md`
...
Repair T8 Release and STOP under entries `0053`, `0054`, `0055`, and `0056`. Add only the
bounded sealed-artifact witnesses requested by Reviewer evidence
`.builder/evidence/reviews/T8/20260903T082012Z-external-review.md`: Linux acceptance
walk, sealed CLI breadth across empty/software/mixed targets, and sealed MCP error
behavior. Do not reopen T0-T7 absent new evidence of a failed premise. Do not park T8,
