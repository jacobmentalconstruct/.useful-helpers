...
```bat
rg "^\[ANCHOR: BCC-WORKFLOW-REQUIRED-TRANCHE-LOOP\]$" .project-mapper\_docs\BCC.md
```
...
[BCC-CONFIG: SIDECAR_ROOT=".project-mapper"]
[BCC-CONFIG: CONTRACT_PATH=".project-mapper/_docs/BCC.md"]
[BCC-CONFIG: JOURNAL_PATH=".project-mapper/_docs/_AppJOURNAL/"]
```
