...
def _provisional_status() -> str:
    ...
    allowed_statuses = (
        ...
        "T7 DECLARED",
        "T7 IMPLEMENTING",
        "T7 AWAITING_APPROVAL IMPLEMENTATION MAP",
        "T7 PARKED IMPLEMENTATION MAP",
        "T8 DECLARED",
        "T8 IMPLEMENTING",
        "T8 VERIFYING IMPLEMENTATION MAP",
        "T8 AWAITING_APPROVAL IMPLEMENTATION MAP",
        "T8 PARKED IMPLEMENTATION MAP",
    )
