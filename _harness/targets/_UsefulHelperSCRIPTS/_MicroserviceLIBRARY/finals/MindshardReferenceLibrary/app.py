...
def main(argv=None):
    parser = argparse.ArgumentParser(description="MindshardReferenceLibrary packaged tool")
    parser.add_argument("--health", action="store_true", help="Print health JSON and exit")
    parser.add_argument("--no-ui", action="store_true", help="Run without launching the Tkinter placeholder")
